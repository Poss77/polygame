-- ============================================================
-- POLYGAME PGT CYBER MYSTERY CRATE ODDS UPDATE SCRIPT
-- 99% Chance: PGT Token Reward (200 - 1,500 PGT, Average = 850 PGT / 85% return)
-- 1% Chance: Ultra-Rare Utility Core NFT Item
-- ============================================================
...
BEGIN
  ...
  IF v_rand <= 99 THEN
    -- 99% chance: PGT Token Cashback (200 to 1,500 PGT, Average = 850 PGT / 85% return)
