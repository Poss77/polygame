-- ==============================================================================
-- POLYGON GAMING: FIX END ARCADE SESSION METRICS EXCEPTION (v1.5.238)
-- Fixes PostgreSQL error 42703 (column "total_plays" does not exist) by using
-- the canonical game_metrics columns safely wrapped in an exception block.
-- ==============================================================================
