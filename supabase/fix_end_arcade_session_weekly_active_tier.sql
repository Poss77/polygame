-- ==============================================================================
-- POLYGON GAMING: FIX "weekly_tier" DOES NOT EXIST IN end_arcade_session
-- Migration: fix_end_arcade_session_weekly_active_tier.sql
-- Version: v1.5.363
-- ==============================================================================
-- Corrects the column name in users table from "weekly_tier" to "weekly_active_tier"
-- and uses canonical compute_weekly_active_tier(p_faucets, p_games).
-- ==============================================================================
