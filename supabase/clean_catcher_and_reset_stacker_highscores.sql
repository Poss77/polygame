-- ==============================================================================
-- POLYGAME MIGRATION: CLEAN CATCHER & RESET STACKER HIGHSCORES
-- ==============================================================================
-- 1. Ensure stacker_highscore and alltime_stacker_highscore columns exist
-- 2. Consolidate career best scores into alltime_stacker_highscore
-- 3. Zero out weekly stacker_highscore and catcher_highscore
-- 4. Update end_arcade_session, submit_arcade_highscore & execute_weekly_payout_and_reset RPCs
-- ==============================================================================
...
-- Optional: Drop legacy catcher columns if desired
...
-- 4. Update submit_arcade_highscore RPC to handle stacker_highscore
...
-- 5. Update end_arcade_session RPC for Cyber Stacker
