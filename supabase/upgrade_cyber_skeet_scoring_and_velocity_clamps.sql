...
-- 5. UPGRADE bind_web3_user_session (REMOVES NON-EXISTENT users.wallet_address)
-- Fixes PostgreSQL Error 42703 (column "wallet_address" does not exist) when authenticating Web3 sessions.
...
GRANT EXECUTE ON FUNCTION public.bind_web3_user_session(TEXT) TO authenticated, service_role, anon;
