...
-- ------------------------------------------------------------------------------
CREATE TEMP TABLE backup_user_referrers (
    player_id TEXT PRIMARY KEY,
    original_l1 TEXT
);

INSERT INTO backup_user_referrers (player_id, original_l1) VALUES
('0xpgtdb4748d3', NULL),
...
SET referred_by_l1 = b.original_l1
FROM backup_user_referrers b
WHERE u.player_id = b.player_id;

DROP TABLE backup_user_referrers;
