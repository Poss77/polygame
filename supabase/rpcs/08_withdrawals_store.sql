...
-- ------------------------------------------------------------------------------
-- RPC: open_pgt_mystery_box
-- Source: update_mystery_crate_odds_85pct.sql & allow_duplicate_mystery_crate_nfts.sql
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- RPC: open_pol_mystery_box
-- Source: fix_mystery_box_rpcs.sql & allow_duplicate_mystery_crate_nfts.sql
-- ------------------------------------------------------------------------------
