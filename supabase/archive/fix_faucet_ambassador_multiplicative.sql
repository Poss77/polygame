-- ============================================================
-- POLYGAME FAUCET RPC FIX: MULTIPLICATIVE AMBASSADOR (2.0x)
-- Sets Official Ambassador to a 2.0x Multiplicative Multiplier
-- ============================================================
...
BEGIN
  ...
  -- Base Payout x (1 + Additive NFT/Streak/Referral Boosts)
  ...
  -- 2.0x Official Ambassador Multiplier
  IF v_is_amb THEN
    v_payout := v_payout * 2.0;
  END IF;
