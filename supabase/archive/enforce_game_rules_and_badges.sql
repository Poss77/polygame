...
CREATE POLICY "Public read boss_reset_history" ON public.boss_reset_history FOR SELECT USING (true);

DROP POLICY IF EXISTS "Service role write boss_reset_history" ON public.boss_reset_history;
CREATE POLICY "Service role write boss_reset_history" ON public.boss_reset_history FOR ALL USING (true) WITH CHECK (true);
