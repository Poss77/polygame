...
export const APP_VERSION = "1.4.176"; // Web3 Wallet connection status accurately checks active browser provider (displaying Not Connected on this device if un-connected locally)
