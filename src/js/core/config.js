...
export const APP_VERSION = "1.4.155"; // Referral page NFT Multiplier badge displays pure NFT boost (e.g. 1.10x), while Ambassador 1.5x boost is shown on Ambassador badge
