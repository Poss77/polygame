...
export const APP_VERSION = "1.4.171"; // Internal Google/Guest address prefix updated to 0xpgt... with dual-column (wallet_address & linked_wallet_address) compatibility
