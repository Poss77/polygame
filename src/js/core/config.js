...
export const APP_VERSION = "1.5.422"; // Withdrawal Safety Shield: Pre-flight POL fee verification, atomic auto-refund on failed wallet transactions & unconsumed recovery
