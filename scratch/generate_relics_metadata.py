...
for r in relics:
    meta = {
        'name': r['name'],
        'description': f"{r['desc']} Authentic PolyGame Serie 1 Quantum Relic NFT. Collect all 17 Serie 1 Relics to activate the permanent 1.5x Apex Arcade & Faucet Multiplier across all games and daily faucet claims.",
        ...
        'attributes': [
            ...
            { 'trait_type': 'Serie', 'value': r['season'] },
            { 'trait_type': 'Set Component', 'value': '1 of 17 Serie 1 Relics' },
            { 'trait_type': 'Set Bonus', 'value': '1.5x Arcade & Faucet Multiplier (When Full Serie 1 Owned)' }
        ]
    }
