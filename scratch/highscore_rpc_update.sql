-- ============================================================
-- POLYGAME ARCADE HIGH SCORE & GREATEST PERSISTENCE RPC
-- Guarantees higher scores never get overwritten by lower scores
-- Run this in your Supabase SQL Editor
-- ============================================================

-- 1. Ensure high score columns exist
...
-- 2. Master Arcade High Score Update RPC using GREATEST
...
BEGIN
  ...
  WHERE LOWER(wallet_address) = LOWER(p_wallet) 
     OR LOWER(linked_wallet_address) = LOWER(p_wallet);

  RETURN jsonb_build_object('success', true);
END;
$$;

-- 3. Invaders Score & High Score RPC using GREATEST
