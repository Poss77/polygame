...
#### 🕹️ 1. Retro Arcade Mini-Games (Earn Free PGT!)
Play directly in your browser with smooth 60 FPS physics & touch controls on mobile & desktop:
* **🚀 Astro-Dodge:** Pilot your neon starship, dodge orbital mines, and collect cyan plasma keys.
* **👾 Cyber Invaders:** Space Invaders arcade reboot—blast wave after wave of neon alien fleets!
* **🏎️ Cyber Drift:** 3D Synthwave racer—dodge traffic, grab nitro boosts, and drift for high scores!

#### 🎲 2. Provably Fair Betting Games & Progressive Jackpot
* **Roshambo (Rock-Paper-Scissors):** Classic PVP against the server algorithm.
* **Lucky Spinner & Cyber Crash:** High-stakes multipliers with live crash meters.
...
1. Visit **[https://polygongaming.io/](https://polygongaming.io/)** on mobile or desktop.
2. Play in **Guest Mode** instantly or connect your Web3 wallet (MetaMask, WalletConnect, etc.).
3. Head to the **Faucet** tab to claim your first free PGT!
4. Launch any arcade game, set a high score, and start earning!
